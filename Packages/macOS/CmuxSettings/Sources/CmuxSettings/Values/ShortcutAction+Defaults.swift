...
extension ShortcutAction {
    ...
    public var defaultStroke: ShortcutStroke? {
        ...
        case .toggleCarouselLayout: return ShortcutStroke(key: "k", command: true, control: true)
        case .carouselNavigatePrevious: return ShortcutStroke(key: "\u{2190}", command: true, control: true)
        case .carouselNavigateNext: return ShortcutStroke(key: "\u{2192}", command: true, control: true)
        case .carouselToggleGrid: return ShortcutStroke(key: "m", command: true, control: true)
