...
final class MenuBarProfilingProgressWindowController: NSWindowController {
    ...
    private init() {
        ...
        window.title = String(localized: "statusMenu.profiling.title", defaultValue: "Profiling Genesis")
    ...
    private func buildInterface() {
        ...
        titleLabel.stringValue = String(localized: "statusMenu.profiling.reviewTitle", defaultValue: "Send a Genesis profile")
        ...
        permissionLabel.stringValue = String(
            ...
            defaultValue: "macOS may ask for administrator permission because Instruments samples the running Genesis process."
        )
