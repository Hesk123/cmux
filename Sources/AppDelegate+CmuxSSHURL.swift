    ...
    var errorDescription: String? {
        ...
        case .launchServicesRegistrationFailed:
            return String(
                ...
                defaultValue: "Genesis could not register as the default terminal app."
            )
        }
    }
}
        ...
        process.terminationHandler = { [weak preferredWindow] terminatedProcess in
            ...
            Task { @MainActor in
                ...
                let format = String(
                    ...
                    defaultValue: "Genesis ssh exited with status %d."
                )
        ...
        do {
            ...
            presentLaunchFailure(
                summary: String(
                    ...
                    defaultValue: "Genesis ssh could not be launched."
                ),
...
extension AppDelegate {
    ...
    private func confirmCmuxTextURLRequest(_ request: CmuxTextURLRequest) -> Bool {
        ...
        let messageFormat = request.kind == .prompt
            ? String(
                ...
                defaultValue: "A %@:// link is asking Genesis to paste a prompt into the current workspace. Genesis cannot verify which website or app opened this link.\n\nGenesis will paste the text into the terminal and will not press Return. Only continue if you trust this prompt."
            )
            : String(
                localized: "dialog.textURL.rules.message",
                defaultValue: "A %@:// link is asking Genesis to paste rules into the current workspace. Genesis cannot verify which website or app opened this link.\n\nGenesis will paste the rules into the terminal and will not write files or press Return. Only continue if you trust these rules."
            )
        alert.informativeText = String(
    ...
    private func cmuxSSHURLAccessoryView(
        ...
        let checkbox = NSButton(
            checkboxWithTitle: String(
                ...
                defaultValue: "I trust this SSH target and want Genesis to connect."
            ),
            target: gate,
    ...
    private func showCmuxSSHURLParseError(_ error: CmuxSSHURLParseError) {
        ...
        alert.messageText = String(
            ...
            defaultValue: "Genesis SSH Link Blocked"
        )
    ...
    private func showCmuxTextURLPasteFailure(_ request: CmuxTextURLRequest) {
        ...
        alert.informativeText = String(
            ...
            defaultValue: "Genesis could not send the link text to a terminal."
        )
        alert.addButton(withTitle: String(localized: "common.ok", defaultValue: "OK"))
        alert.runModal()
    }
    ...
    private func showCmuxTextURLParseError(_ error: CmuxTextURLParseError) {
        ...
        alert.messageText = String(
            ...
            defaultValue: "Genesis Link Blocked"
        )
    ...
    private func cmuxSSHURLParseErrorMessage(_ error: CmuxSSHURLParseError) -> String {
        ...
        case .destinationContainsUnsafeCharacters:
            return String(
                ...
                defaultValue: "The SSH host or user contains unsupported or hidden characters, so Genesis refused to use it."
            )
        ...
        case .titleContainsUnsafeCharacters:
            return String(
                ...
                defaultValue: "The workspace title contains hidden control or formatting characters, so Genesis refused to use it."
            )
        case .invalidPort:
            return String(
    ...
    private func cmuxTextURLParseErrorMessage(_ error: CmuxTextURLParseError) -> String {
        ...
        case .textContainsUnsafeCharacters:
            return String(
                ...
                defaultValue: "The link text contains unsupported or hidden characters, so Genesis refused to use it."
            )
        ...
        case .nameContainsUnsafeCharacters:
            return String(
                ...
                defaultValue: "The link name contains hidden control or formatting characters, so Genesis refused to use it."
            )
        case .titleTooLong(let maxLength):
            return String(
        ...
        case .titleContainsUnsafeCharacters:
            return String(
                ...
                defaultValue: "The link title contains hidden control or formatting characters, so Genesis refused to use it."
            )
        case .invalidBooleanParameter(let parameter):
            return String(
        ...
        case .multipleLinks:
            return String(
                ...
                defaultValue: "Only one Genesis external link can be opened at a time."
            )
        }
    }
}
