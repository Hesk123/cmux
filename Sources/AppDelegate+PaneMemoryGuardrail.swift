    ...
    private func postPersistentCriticalMemoryPressureWarning(snapshot: MemoryPressureSnapshot) {
        ...
        notificationStore.addNotification(
            ...
            title: String(
                ...
                defaultValue: "Genesis is under critical memory pressure"
            ),
            subtitle: String(
            ...
            body: String(
                ...
                defaultValue: "macOS is reporting sustained critical memory pressure. Genesis has shed hidden resources; close idle workspaces or restart Genesis if pressure continues."
            ),
