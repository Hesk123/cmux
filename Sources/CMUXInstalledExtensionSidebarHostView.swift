...
struct CMUXInstalledExtensionSidebarHostView: View {
    ...
    private func observeExtensionAvailability() async {
        ...
        do {
            ...
            errorText = String(
                ...
                defaultValue: "GENESIS could not load sidebar extensions."
            )
        }
    }
    ...
    private var emptyStateDetail: String {
        ...
        return String(
            ...
            defaultValue: "Install and enable a GENESIS sidebar extension to show it here."
        )
    }
    ...
    private var extensionAvailabilityDetail: String {
        if unapprovedExtensionCount > 0 {
            return String(
                ...
                defaultValue: "An installed sidebar extension needs approval before GENESIS can use it."
            )
        }
        return String(
    ...
    private func blockedDetailText(reason: String) -> String {
        switch reason {
        case "connectionInterrupted":
            return String(localized: "sidebar.extensions.blocked.detail.connectionInterrupted", defaultValue: "GENESIS lost the extension connection. No workspace data or actions are being shared.")
        case "manifestTimedOut":
            return String(localized: "sidebar.extensions.blocked.detail.manifestTimedOut", defaultValue: "GENESIS did not receive this extension's configuration in time. No workspace data or actions are being shared.")
        case "missingManifest":
            return String(localized: "sidebar.extensions.blocked.detail.missingManifest", defaultValue: "GENESIS did not receive a sidebar extension configuration, so no workspace data or actions were shared.")
        case "invalidManifest":
            return String(localized: "sidebar.extensions.blocked.detail.invalidManifest", defaultValue: "GENESIS rejected this extension's configuration. No workspace data or actions were shared.")
        default:
            return String(localized: "sidebar.extensions.blocked.detail.failedManifest", defaultValue: "GENESIS could not load this extension's configuration. No workspace data or actions were shared.")
        }
    }
    ...
    private func accessReviewSheet(
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text(String(localized: "sidebar.extensions.access.review.detail", defaultValue: "GENESIS will only share the following data and actions if you allow this request."))
                .cmuxFont(size: 12)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
