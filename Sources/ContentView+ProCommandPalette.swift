    ...
    static func commandPaletteProCommandContributions() -> [CommandPaletteCommandContribution] {
        ...
        return [
            CommandPaletteCommandContribution(
                ...
                title: constant(String(localized: "command.pro.welcomeChecklist.title", defaultValue: "Welcome to Genesis Pro")),
            ...
            CommandPaletteCommandContribution(
                ...
                title: constant(String(localized: "command.pro.upgrade.title", defaultValue: "Upgrade to Genesis Pro")),
                subtitle: constant(String(localized: "command.auth.subtitle", defaultValue: "Account")),
