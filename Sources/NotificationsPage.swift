        ...
        VStack(alignment: .leading, spacing: 6) {
            Toggle(isOn: forwardToPhoneBinding) {
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text(String(localized: "notifications.forwardToPhone.subtitle", defaultValue: "Send local agent notifications to Genesis on your iPhone. Enabled by default; turn this off to stop this Mac from forwarding them."))
                        .cmuxFont(.caption)
