        ...
        case .destinationProfileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No Genesis browser profile matches '%@'"
                ),
                query
            )
        case .destinationProfileCreationFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to create Genesis browser profile '%@'"
                ),
                name
            )
        }
    ...
    var errorDescription: String? {
        ...
        case .browserDisabled:
            return String(
                ...
                defaultValue: "Browser profiles cannot be used while the Genesis browser is disabled"
            )
        case .invalidProfileSelector:
            return String(
        ...
        case .profileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No Genesis browser profile matches '%@'. Run 'Genesis browser profiles' to list available profiles."
                ),
                query
            )
        case .ambiguousProfile(let query, let candidates):
            ...
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Multiple Genesis browser profiles match '%@': %@. Use a profile UUID."
                ),
                query,
                candidateList
            )
        ...
        case .profileRenameFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to rename Genesis browser profile to '%@'"
                ),
                name
            )
        case .cannotDeleteDefaultProfile:
        ...
        case .profileInUse(let name, let count):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Cannot delete Genesis browser profile '%@' while %d browser panel(s) are using it"
                ),
                name,
                count
            )
        case .profileDeleteFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to delete Genesis browser profile '%@'"
                ),
                name
            )
        case .profileClearFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to clear Genesis browser profile '%@'"
                ),
                name
            )
        }
