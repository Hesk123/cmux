    ...
    private var currentBannerText: String? {
        ...
        case .cmux:
            return String(
                ...
                defaultValue: "This is the Genesis Ghostty config selected for this build. Edit it here, then Save to reload Genesis."
            )
        case .synced:
            if currentSnapshot.hasStandaloneGhosttyConfig {
                return String(
                    localized: "settings.config.banner.synced",
                    defaultValue: "This is a generated preview of the effective config. Edit the Genesis tab to change what Genesis reads."
                )
            }
            return String(
                localized: "settings.config.banner.syncedNoGhostty",
                defaultValue: "This is a generated preview of the effective config. No base Ghostty config file was found, so only Genesis overrides are shown."
            )
        }
    }
    ...
    private func saveCmuxConfig() {
        ...
        do {
            ...
            statusMessage = String(
                ...
                defaultValue: "Couldn't save the Genesis config."
            )
            statusIsError = true
        }
    }
    ...
    private func materializedCmuxConfigURL() -> URL? {
        ...
        do {
            ...
            statusMessage = String(
                ...
                defaultValue: "Couldn't open the Genesis config."
            )
            statusIsError = true
            return nil
        }
...
private extension ConfigSource {
    var localizedTitle: String {
        switch self {
        case .cmux:
            return String(localized: "settings.config.source.cmux", defaultValue: "Genesis")
        case .synced:
