...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.account, "pro", String(localized: "settings.account.pro.title", defaultValue: "Genesis Pro"), "pro upgrade subscription billing plan pricing cloud"),
        ...
        setting(.app, "supported-file-previews", String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in Genesis"), "cmd click file preview pdf image audio video quick look editor"),
        ...
        setting(.app, "markdown-viewer", String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in Genesis Viewer"), "md markdown viewer"),
        ...
        setting(.sidebarAppearance, "open-pr-links", String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in Genesis Browser"), "pull request link browser"),
        setting(.sidebarAppearance, "open-port-links", String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in Genesis Browser"), "port link browser"),
        ...
        setting(.browser, "enable-browser", String(localized: "settings.browser.enabled", defaultValue: "Enable Genesis Browser"), "webview tabs links"),
        ...
        setting(.browser, "terminal-links", String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in Genesis Browser"), "click links browser"),
