...
final class Workspace: Identifiable, ObservableObject, FilePreviewTabMetadataHost {
    ...
    private static func shouldRunPromptedSurfaceResumeOnMain(_ binding: SurfaceResumeBindingSnapshot) -> Bool {
        ...
        let informativeText = String(
            format: String(
                ...
                defaultValue: "Genesis is restoring a terminal with this resume command:\n\nWorking directory: %@\n\n%@"
            ),
    ...
    private func showMoveTabFailureAlert() {
        ...
        failure.informativeText = String(localized: "alert.moveTab.failed.message", defaultValue: "Genesis could not move this tab to the selected destination.")
